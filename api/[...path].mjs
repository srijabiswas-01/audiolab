...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === 'GET' && url.pathname === '/api/status') {
      ...
      return send(res, 200, { setupRequired: n === 0, user: cleanUser(await current(req)) || null, capabilities: { localAudio: true, wavExport: true, separation: false, transcription: false, urlImport: false } });
    }
